...
from game_infos import game_infos, game_infos_with_cover, categories
import json
...
def games():
    ...
    games_to_show = game_infos['games']
    if category:
        games_to_show = {
    ...
    return render_template('games.html', games=games_to_show, categories=categories, selected_category=category)
